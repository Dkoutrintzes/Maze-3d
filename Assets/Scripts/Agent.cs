...
public class Agent : MonoBehaviour
{
     ...
     */
    {
        ...
        {
            res = UnityWebRequest.PostWwwForm(HOST + route, UnityWebRequest.kHttpVerbPOST);
     ...
     */
    {
        while (true)
        {
            ...
            // if( last_mode == "training" && state != "training")
            // {
            //     on_pause = true;
            // }
            // last_mode = state;
    ...
    void set_step_response(string state)
    /*
